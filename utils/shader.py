...
class Shader:
	...
	def compile(self, defines):
		...
		define_code = ''#'uniform vec3[' + str(int(n_wavelengths)) + '] iCurve;\n'

		for k in defines.params:
			param = to_str(defines.params[k])
